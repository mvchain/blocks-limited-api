...
public class YupianJavaSmsApi {
    ...
    public static void main(String[] args) throws IOException,
        ...
        /**************** 查账户信息调用示例 *****************/
        System.out.println(YupianJavaSmsApi.getUserInfo(apikey));
        ...
        System.out.println(YupianJavaSmsApi.tplSendSms(apikey, tpl_id, tpl_value,
                mobile));
